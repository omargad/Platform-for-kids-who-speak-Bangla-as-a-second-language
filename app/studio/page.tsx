  ...
  return (
    <main className="adult-app studio-app">
      <header className="adult-header">
        ...
        <nav aria-label="Adult tools"><a href="/family">Learners</a><a className="active" href="/studio">Content Studio</a><Link href="/worksheets">Worksheets</Link><a href="/safety">Safety & access</a><a href="/account">Account</a></nav>
