          ...
          >
            ...
            {modal.type === "grownups" && (
              <div className="grownups-content">
                ...
                <div className="grownup-tool-links"><a href="/family">Open learner dashboard →</a><a href="/studio">Open Content Studio →</a><Link href="/worksheets">Print lesson worksheets →</Link><a href="/safety">Read safety & accessibility →</a></div>
