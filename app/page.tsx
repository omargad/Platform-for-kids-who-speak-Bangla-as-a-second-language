          ...
          >
            ...
            {modal.type === "grownups" && (
              <div className="grownups-content">
                ...
                <div className="grownup-tool-links"><a href="/family">Open learner dashboard →</a><a href="/studio">Open Content Studio →</a><a href="/safety">Read safety & accessibility →</a></div>
