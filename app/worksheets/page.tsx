  ...
  return (
    <main className="adult-app worksheets-app">
      <header className="adult-header">
        ...
        <nav aria-label="Platform information"><Link href="/">Learner site</Link><Link className="active" href="/worksheets">Worksheets</Link><Link href="/resources">Resources</Link><Link href="/certificate">Certificates</Link><a href="/family">Grown-up dashboard</a><a href="/safety">Safety &amp; access</a></nav>
